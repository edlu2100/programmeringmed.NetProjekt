...
namespace programmeringmed.NetProjekt.Controllers
{
    public class SkiingController : Controller
    {
        ...
        public async Task<IActionResult> Create(int workoutId, [Bind("Id,Location,Organization,DisciplineId,MethodId,FocusId,TurnsPerRun,GateDistance,Freeruns,Runs,CompletedRuns,ApproachToTask,Goal")] SkiingModel skiingModel)
        {
